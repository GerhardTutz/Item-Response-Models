...
LoglikN <-function(par,dat,I,indicator, lin=lin ){
  ...
  for (p in 1:P){
    ...
    #prodfct(theta,datitem=datitem,I=I,parmatr=parmatr,slope=slope,indicator=indicator, lin =lin) 
    #gauss.hermite(prodfct, mu = 0, sd = 1,datitem=datitem,I=I,parmatr=parmatr,slope=slope,indicator=indicator,lin =lin)
