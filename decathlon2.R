...
### specify data and scale of response
...
cov0<-matrix(0,1,dim(decaselecttr)[2])  ### dummy covariates


#### fit with response and difficulty implicitly modified (holds outside function!)
# first run ProgramsBsplinesPureResp


###  if response function is Nv
ThrN<-ThreshIncl(respf="NV",lin="lin",decaselecttr,basis="lin",indicatorvec,ord=4, numknotsstart=6,lambdpenin=0,lambdc=0,start, 
                             startind = "no",der="der",cov0,hessiander="FALSE")

## use if response function is Gompertz
ThrGompertz<-ThreshIncl(respf="Gompertz",lin="lin",decaselecttr,basis="lin",indicatorvec,ord=4, numknotsstart=6,lambdpenin=0,lambdc=0,start, 
                             startind = "no",der="der",cov0,hessiander="FALSE")

## use if response function is Gumbel
ThrGumb <-ThreshIncl(respf="Gumbel",lin="lin",decaselecttr,basis="lin",indicatorvec,ord=4, numknotsstart=6,lambdpenin=0,lambdc=0,start, 
                                    startind = "no",der="der",cov0,hessiander="FALSE")


### with start values from NV fit (if start values are bad)

ThrGumb<-ThreshIncl(respf="Gumbel",lin="lin",decaselecttr,basis="lin",indicatorvec,ord=4, numknotsstart=6,lambdpenin=0,lambdc=0,start=ThrNV$par, 
                            startind = "yes",der="der",cov0,hessiander="FALSE")

ThrGompertz<-ThreshIncl(respf="Gompertz",lin="lin",decaselecttr,basis="lin",indicatorvec,ord=4, numknotsstart=6,lambdpenin=0,lambdc=0,start=ThrNV$par, 
                                startind = "yes",der="der",cov0,hessiander="FALSE")
...
### older version with first selection of difficulty and response 
### select first difficulty and response 
